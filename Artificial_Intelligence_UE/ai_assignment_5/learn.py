...
from ai_assignments.utils.printing import print_decision_tree
import argparse
import textwrap
import hashlib
import time
...
def main():
    parser = argparse.ArgumentParser(
        ...
        $ python learn.py test/data.json id3
        this loads the training set stored in 'test/data.json' and learns
