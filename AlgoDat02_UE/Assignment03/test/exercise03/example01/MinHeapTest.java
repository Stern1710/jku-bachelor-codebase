...
import exercise03.example01.MinHeap;
...
class MinHeapTest {
    ...
    private MinHeap<Long> heap = new MinHeap<Long>(3);
    ...
    void vorlesungsFolien() {
        ...
        final MinHeap<Long> heap = new MinHeap<Long>(longs);
